...
TARGETS='build_powerpc_cdrom build_powerpc_netboot build_powerpc_hd-media build_powerpc_gtk-miniiso build_powerpc64_netboot build_powerpc64_gtk-miniiso build_powerpc64_cdrom build_prep_cdrom build_prep_netboot build_prep_hd-media' 
