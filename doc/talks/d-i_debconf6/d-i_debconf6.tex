...
% Problem here: < and > printed as inverted ! and ?; same in other places
...
% Problem here: -- before --add-udeb is interpreted as an mdash!
...
% Problem here: The ^ before ^build is placed over the b instead of before it
