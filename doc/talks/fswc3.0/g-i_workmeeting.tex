...
\date[February 2007] % (optional, should be abbreviation of conference name)
...
\begin{frame}
  ...
  \pgfdeclareimage[width=10cm]{frontends}{frontends}
  \pgfuseimage{frontends}
\end{frame}

\begin{frame}
  \frametitle{The text frontend}
  \pgfdeclareimage[width=9cm]{text}{fe_text}
  \pgfuseimage{text}
\end{frame}

\begin{frame}
  \frametitle{The textual (newt) frontend}
  \pgfdeclareimage[width=9cm]{newt}{fe_newt}
  \pgfuseimage{newt}
\end{frame}

\begin{frame}
  \frametitle{The graphical (gtk) frontend}
  \pgfdeclareimage[width=9cm]{gtk}{fe_gtk}
  \pgfuseimage{gtk}
\end{frame}
