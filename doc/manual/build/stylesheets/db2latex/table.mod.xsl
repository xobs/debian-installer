	...
	<doc:template xmlns="">
		...
		<doc:notes>
			...
			<para>
				...
				The <sgmltag class="pi">db2latex-no-caption</sgmltag> processing
				instruction can be used to suppress the emission of the title
				as a caption in &LaTeX;.
		...
		<doc:params>
			<variablelist>
				<varlistentry>
					<term>width</term>
					<listitem><simpara>
						The width of the table in &LaTeX; units.
					</simpara></listitem>
				</varlistentry>
			</variablelist>
		</doc:params>
